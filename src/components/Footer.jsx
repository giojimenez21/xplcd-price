...
export const Footer = () => {
    return (
        <footer style={{ fontSize: 14 }}>
                    ...
                    <div>
                        <div>
                            ...
                            <p>
                                ...
                                <a href="https://wa.me/message/ETTWEY7GULOOK1"> Whatsapp </a>
                            </p>
                            <p>
                                <i className="fa fa-phone"></i> ~ 2do piso, #320-321
                                <a href="https://api.whatsapp.com/send?phone=5632955227"> Whatsapp</a>
                            </p>
                            <p><i className="fa fa-location-arrow"></i> ~ Piso 20 de la Torre Latinoamericana, Centro Histórico de la Ciudad de México.</p>
                            <p><i className="fa fa-phone"></i> ~ Ingeniería móvil - <a href="https://api.whatsapp.com/send?phone=5617653201">Whatsapp</a></p>
            ...
            <p className="text-center"> Iconos creados por  <a href="https://www.flaticon.es">Freepik - Flaticon</a></p>
